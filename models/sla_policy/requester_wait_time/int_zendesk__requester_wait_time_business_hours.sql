...
-- cross schedules with work time
    ...
    select 
      ...
      least(ticket_week_end_time_minute, schedule.end_time) - greatest(weekly_period_requester_wait_time.ticket_week_start_time_minute, schedule.start_time) as scheduled_minutes
