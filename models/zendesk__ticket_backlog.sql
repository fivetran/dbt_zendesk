...
{% endif %}
    ...
    left join ticket_forms
        on ticket_forms.ticket_form_id = ticket_field_history.ticket_form_id
    {% endif %}
    ...
    left join group_names
        on group_names.group_id = ticket_field_history.group_id
    {% endif %}
    ...
    left join users as assignee
        on assignee.user_id = ticket_field_history.assignee_id
    {% endif %}
    ...
    left join users as requester
        on requester.user_id = ticket_field_history.requester_id
    {% endif %}
    ...
    left join brands
        on brands.brand_id = ticket_field_history.brand_id
    {% endif %}
    ...
    left join organizations
        on organizations.organization_id = ticket_field_history.organization_id
    {% endif %}
