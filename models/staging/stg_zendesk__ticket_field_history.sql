...
fields as (
    ...
    select
        ...
        */
        ...
        {{ fivetran_utils.apply_source_relation('zendesk') }}
...
final as (
    ...
    select 
        ...
        cast(lead(updated) over (partition by ticket_id, field_name {{ fivetran_utils.partition_by_source_relation('zendesk') }} order by updated) as {{ dbt.type_timestamp() }}) as valid_ending_at,
        value,
        user_id,
        source_relation
