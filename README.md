...
> 
> By default, all variables' values are assumed to be `true`, except for `using_ticket_chat` and  `using_audit_log`. Add variables for only the tables you want to enable/disable:
